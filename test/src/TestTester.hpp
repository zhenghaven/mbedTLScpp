...
GTEST_TEST(TestGeneral, TestBytes2Bin)
{
	...
	EXPECT_EQ(Internal::Bytes2BinSmlEnd(CtnFullR(CDynArray<const uint64_t>{&a, 1})), "1101100110010100111001001010101110101010101010000110101000000000");
	EXPECT_EQ(Internal::Bytes2BinSmlEnd(CtnFullR(CDynArray<const uint64_t>{&b, 1})), "1101010101000101110101010101010110101001101010110000100100000000");
	EXPECT_EQ(Internal::Bytes2BinSmlEnd<9>(CtnFullR(CDynArray<const uint64_t>{&a, 1})), "110110011001010011100100101010111010101010101000011010100000000000000000");
	EXPECT_EQ(Internal::Bytes2BinSmlEnd<9>(CtnFullR(CDynArray<const uint64_t>{&b, 1})), "110101010100010111010101010101011010100110101011000010010000000000000000");
}
