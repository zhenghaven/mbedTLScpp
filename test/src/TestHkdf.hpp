...
GTEST_TEST(TestHkdf, HkdfCalc)
{
...

	{
		...
		EXPECT_EQ(Internal::Bytes2HexSmlEnd(CtnFullR(genKey.Get())), "b887d7064cea6f446b4ba466ddd6177a");
	}

	{
		auto genKey = Hkdf<HashType::SHA512, 256>(SCtnFullR(oriKey), CtnFullR(label), CtnFullR(gsk_emptyCtn));
		EXPECT_EQ(Internal::Bytes2HexSmlEnd(CtnFullR(genKey.Get())), "703ab3362633c91f5943966e8a39538956ba1ae2f7845920dcb1f6e9cc081198");
	}
}
